...
![Open Issues](https://img.shields.io/github/issues/haf1786/qa-library-pipeline)
![Open PRs](https://img.shields.io/github/issues-pr/haf1786/qa-library-pipeline)
![Last Commit](https://img.shields.io/github/last-commit/haf1786/qa-library-pipeline)
![CI Pipeline Badge](https://github.com/haf1786/qa-library-pipeline/actions/workflows/ci.yml/badge.svg)
...
git config --global user.name "Haf"
```

### Local Development
```bash
# Clone this repository
git clone https://github.com/haf1786/qa-library-pipeline.git
